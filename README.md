...
[**Browse the catalog →**](https://onda.dev/components) &nbsp;·&nbsp; [**Getting started →**](https://onda.dev/docs)
...
> [!TIP]
> Components depend on **Clash Display** and **Space Grotesk** — load them once at the project root and every Onda primitive looks right by default. Setup details in [/docs](https://onda.dev/docs).
...
Browse the full catalog at **[onda.dev/components](https://onda.dev/components)** — every component has a live preview, a "Try it" props panel, and the exact install command.
...
- [Getting started](https://onda.dev/docs) — install → fonts → first composition
- [Components catalog](https://onda.dev/components) — every primitive, live previews, props
...
├── www/                  Next.js docs + catalog site (onda.dev)
